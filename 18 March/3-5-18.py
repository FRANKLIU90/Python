...
# my_words = 'name is {name} , age is {age}'.format(**person)
# print(my_words)
...
sentence = 'My name is {name} and I am {age} years old.{name}'.format(name='Jenn', age='30')
print(sentence)
...
for i in range(1, 11):
    sentence = 'The value is {:02.2f}'.format(i)
    print(sentence)
